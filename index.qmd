...
## [`elements` para los paneles]{style="color:#88398A"}
...
## [`elements` para subplots, facets]{style="color:#88398A"}
...
### <span style="color:#88398A">Multidimensional scaling</span>
...
## <span style="color:#88398A">`ggplot2`a interactivo con `plotly`</span>
...
- Hay 4 interactividades básicas que se pueden realizar con el mouse (`click`, `dblClick`, `hover`y `brush`)
```{r}
?plotOutput
```
